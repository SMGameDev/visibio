...
var serverCmd = &cobra.Command{
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		server.dying = dying.New(server.remover)
		server.moving = moving.New(world)
		server.networking = networking.New(world, server.remover)
		...
		http.HandleFunc("/", server.connect)
...
func (s *server) connect(w http.ResponseWriter, r *http.Request) {
	...
	s.networking.Add(net.HandleWebsocket(conn))
}
